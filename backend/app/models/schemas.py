...
# TerminologyAnchor + TerminologyAnchors now live in the psdl_anchoring package.
from psdl_anchoring import TerminologyAnchor, TerminologyAnchors  # noqa: F401  re-exported
