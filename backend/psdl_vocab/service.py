...
class VocabularyService:
    ...
    def __init__(self):
        from ._data_loader import get_vocab_data_path
        self._vocab_dir = get_vocab_data_path()
    ...
    def load(self) -> None:
        ...
        vocab_file = self._vocab_dir / "vocabulary_final.json"
        if not vocab_file.exists():
            vocab_file = self._vocab_dir / "vocabulary_partial.json"

        if not vocab_file.exists():
            raise FileNotFoundError(f"No vocabulary file found in {self._vocab_dir}")
